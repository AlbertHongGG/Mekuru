...
/// Create a copy of Comic
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? comicId = null,Object? providerId = freezed,Object? title = null,Object? coverUrl = freezed,Object? description = freezed,Object? tags = freezed,Object? author = freezed,Object? status = freezed,}) {
  return _then(Comic(
...
class _Comic implements Comic {
  const _Comic({@JsonKey(name: 'id') required this.comicId, @JsonKey(name: 'provider_id') this.providerId, required this.title, @JsonKey(name: 'cover_url') this.coverUrl, this.description,  List<String>? tags, this.author, @JsonKey(name: 'update_status') this.status}): _tags = tags;
...
/// Create a copy of Comic
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? comicId = null,Object? providerId = freezed,Object? title = null,Object? coverUrl = freezed,Object? description = freezed,Object? tags = freezed,Object? author = freezed,Object? status = freezed,}) {
  return _then(_Comic(
comicId: null == comicId ? _self.comicId : comicId // ignore: cast_nullable_to_non_nullable
as String,providerId: freezed == providerId ? _self.providerId : providerId // ignore: cast_nullable_to_non_nullable
as String?,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
