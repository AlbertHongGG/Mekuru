  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final subtitle = DateFormat('HH:mm:ss').format(log.timestamp);
...
class _ApiLogListPageState extends ConsumerState<ApiLogListPage>
  ...
  Widget build(BuildContext context) {
    ...
    final logsAsync = ref.watch(apiLogsProvider);

    final allLogs = logsAsync.valueOrNull?.whereType<ApiLogEntry>().toList() ?? [];
            ...
            child: Center(
              child: DragTarget<ApiLogEntry>(
                onAcceptWithDetails: (details) async {
                  await ref.read(apiLogsProvider.notifier).removeLog(details.data.id);
                },
