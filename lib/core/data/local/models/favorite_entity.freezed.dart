...
mixin _$FavoriteEntity {
 ...
 String get comicId; DateTime get favoriteAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoriteEntity&&(identical(other.comicId, comicId) || other.comicId == comicId)&&(identical(other.favoriteAt, favoriteAt) || other.favoriteAt == favoriteAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,comicId,favoriteAt);

@override
String toString() {
  return 'FavoriteEntity(comicId: $comicId, favoriteAt: $favoriteAt)';
}
...
@useResult
$Res call({
 String comicId, DateTime favoriteAt
});
...
/// Create a copy of FavoriteEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? comicId = null,Object? favoriteAt = null,}) {
  return _then(FavoriteEntity(
comicId: null == comicId ? _self.comicId : comicId // ignore: cast_nullable_to_non_nullable
as String,favoriteAt: null == favoriteAt ? _self.favoriteAt : favoriteAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String comicId,  DateTime favoriteAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FavoriteEntity() when $default != null:
return $default(_that.comicId,_that.favoriteAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String comicId,  DateTime favoriteAt)  $default,) {final _that = this;
switch (_that) {
case _FavoriteEntity():
return $default(_that.comicId,_that.favoriteAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String comicId,  DateTime favoriteAt)?  $default,) {final _that = this;
switch (_that) {
case _FavoriteEntity() when $default != null:
return $default(_that.comicId,_that.favoriteAt);case _:
  return null;
...
class _FavoriteEntity implements FavoriteEntity {
  const _FavoriteEntity({required this.comicId, required this.favoriteAt});
  factory _FavoriteEntity.fromJson(Map<String, dynamic> json) => _$FavoriteEntityFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$FavoriteEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FavoriteEntity&&(identical(other.comicId, comicId) || other.comicId == comicId)&&(identical(other.favoriteAt, favoriteAt) || other.favoriteAt == favoriteAt));
}
...
/// Create a copy of FavoriteEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? comicId = null,Object? favoriteAt = null,}) {
