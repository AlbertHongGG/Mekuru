        ...
        child: Column(
          ...
          children: [
            ...
            SwipeToObliterateButton(
              onConfirmed: () async {
                await ref.read(systemLogsProvider.notifier).clearLogs();
        ...
        children: [
          CustomScrollView(
            slivers: [
              ...
              logsAsync.when(
                data: (allLogs) {
                  final systemLogs = allLogs.whereType<SystemLogEntry>().toList();
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          final displayTime = '$y/$m/$d $h:$min:$s';
                          
                          final color = _getColorForType(type);
                                
                          return LongPressDraggable<SystemLogEntry>(
                            data: log,
                            feedback: SizedBox(
          ...
          Positioned(
            ...
            right: 0,
            child: Center(
              child: DragTarget<SystemLogEntry>(
